...
def run(path='E:\\data\\taxidata\\beijing\\20140301grid.csv', pathod='E:\\data\\taxidata\\beijing.csv'):
    ...
    temp_path='D:\\modelS'+str(gama)+'_'+str(people_num)+"_"+getmon+getday+gethour
